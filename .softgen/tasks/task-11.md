...
## Checklist
- [x] Create `settings` table di Supabase dengan RLS
- [x] Create settings.tsx page dengan form untuk 3 API providers
- [x] Form Dripsender: API key, webhook URL
- [x] Form Cloudchat: API key, endpoint
- [x] Form AI Auto-reply: toggle OpenAI/Gemini, API keys, model selection
- [x] Add Settings link di DashboardLayout sidebar
- [x] Implement save/update settings dengan toast notification
